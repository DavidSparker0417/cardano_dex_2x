...
-- 21/08, David, Basic utility functions
module SumoSwap.Utils.OnChainUtils
  ( assertPoolValue,
    mustFindScriptDatum,
    mustFindScriptDatum',
    integerToBS,
...
import SumoSwap.Types.Coin (adaCoin, assetClassValueOf)
...
-- Estimate pool amount and depth
...
-- Find if there are exist valid datum for transaction
...
-- Mandatory of existing datum for script
{-# INLINEABLE mustFindScriptDatum' #-}

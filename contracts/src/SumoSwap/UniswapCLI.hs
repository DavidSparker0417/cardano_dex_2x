...
import SumoSwap.BatchOrder.OnChain
import SumoSwap.ConstantProductFactory.OnChain
import SumoSwap.ConstantProductLiquidity.OnChain
import SumoSwap.ConstantProductPool.OnChain
import SumoSwap.ConstantProductPoolNFT.OnChain
import Plutus.V1.Ledger.Scripts (Script, scriptSize)
import qualified Plutus.V1.Ledger.Api as Plutus
import System.Environment (getArgs)
import Prelude

-- 20/08, David, Generate compiled plutus tx core files 
main :: IO ()
main = do
  args <- getArgs
  case head args of
...
-- generate results to "plutus" directory

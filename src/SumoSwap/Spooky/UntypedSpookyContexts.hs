...
-- 17/08, David, Evaluating UTXO and datum for accounts and transaction scripts
...
module SumoSwap.Spooky.UntypedSpookyContexts
  ( ScriptContext (..),
    scriptContextTxInfo,
...
import SumoSwap.Spooky.Untyped (Spooky, unSpooky)
...
-- 18/08, David, Miscellanouse types and basic funtion of Spooky
